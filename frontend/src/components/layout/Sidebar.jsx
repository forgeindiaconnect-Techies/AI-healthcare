...
const navItems = {
  ...
  doctor: [
    { id: "dashboard/doctor", label: "Dashboard", icon: <Home size={20} /> },
    ...
    { id: "dashboard/doctor/generate-report", label: "Generate Report (PDF)", icon: <File size={20} /> },
  ...
  admin: [
    ...
    { id: "dashboard/admin/pending-approvals", label: "Pending Approvals", icon: <UserCheck size={20} /> },
