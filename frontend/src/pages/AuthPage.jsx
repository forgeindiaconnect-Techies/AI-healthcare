        ...
        {mode === "login" && (
          <div style={{ marginBottom: 24 }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              {quickLogins.map(q => (
                <button key={q.label} onClick={() => { /* Do nothing, auto-fill removed as requested */ }} style={{ flex: 1, padding: "8px 4px", borderRadius: 8, border: `1px solid ${colors.border}`, background: colors.surfaceAlt, cursor: "pointer", fontSize: 12, color: colors.text, display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
