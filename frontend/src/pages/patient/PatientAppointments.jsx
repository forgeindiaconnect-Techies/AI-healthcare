  ...
  useEffect(() => {
    if (socket) {
      ...
      const handleReminder = (data) => {
        ...
        const isOnline = appointment.appointmentType === 'ONLINE' || appointment.mode === 'video';
              ...
              <div key={apt._id} className="bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow overflow-hidden flex flex-col group">
                ...
                <div className="p-6 flex items-center gap-4">
                  ...
                  <div className="px-6 pb-6 space-y-4 flex-grow">
                    {/* For ONLINE appointments, show date and time at the top.
                        For OFFLINE, they might be null, so conditionally render or show Preferred Date */}
                  ...
                  <div className="pt-2 border-t border-gray-100">
                    <p className="text-xs text-gray-500 italic"><span className="font-bold not-italic text-gray-700">Reason:</span> {apt.reason || 'None provided'}</p>
                  </div>
                </div>
