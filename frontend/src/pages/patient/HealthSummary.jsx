  ...
  return (
    <div style={{ padding: 24, fontFamily: "'Inter', sans-serif", maxWidth: 1200, margin: '0 auto' }}>
      <div style={{ marginBottom: 24 }}>
        <h1 style={{ fontSize: 24, fontWeight: 700, margin: 0, color: colors.text }}>Health Summary</h1>
      ...
      <Card style={{ padding: 60, textAlign: 'center' }}>
        ...
        <p style={{ margin: 0, color: colors.textMuted, fontSize: 14 }}>We are actively building the Health Summary module. Check back soon!</p>
      </Card>
    </div>
  );
};
